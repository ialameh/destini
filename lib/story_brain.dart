...
List<Story> _storyData = [
 Story(
     ...
     choice1: ['I\'ll hop in. Thanks for the help!', 2],
     choice2: ['Better ask him if he\'s a murderer first.', 1]),
 Story(
 storyTitle: 'He nods slowly, unphased by the question.',
 choice1: ['At least he\'s honest. I\'ll climb in.', 2],
 choice2: ['Wait, I know how to change a tire.', 3]),
 Story(
 storyTitle:
 'As you begin to drive, the stranger starts talking about his relationship with his mother. He gets angrier and angrier by the minute. He asks you to open the glovebox. Inside you find a bloody knife, two severed fingers, and a cassette tape of Elton John. He reaches for the glove box.',
 choice1: ['I love Elton John! Hand him the cassette tape.', 5],
 choice2: ['It\'s him or me! You take the knife and stab him.', 4]),
 Story(
 storyTitle:
...
void nextStory(int choiceNumber){
  //_storyNumber = _storyData[_storyNumber].choiceNumber.[1];
if ([_storyData[_storyNumber].choice1[1], _storyData[_storyNumber].choice1[1]].contains(0) ) {restart(); } else {
_storyNumber = [_storyData[_storyNumber].choice1[1], _storyData[_storyNumber].choice2[1]][choiceNumber -1];}
}
...
bool buttonShouldBeVisible() {
  return (_storyData[_storyNumber].choice1[1] != 0);
}
}